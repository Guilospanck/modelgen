// The describe topics: plain text, no file access, so the browser playground can use them too.
import { PATTERNS, PLANS, SLOTS, SHAPE_KEYS } from "../document/schema";
import { MAX_OPS } from "../document/ops";
import { VIEW_PRESETS } from "./views";
...
undo / redo step through edits. Edits keep the YAML's comments and formatting.`,
