...
test("the web bundle runs without Node's Buffer and zlib", async () => {
  ...
  await buildWeb(out);
  expect(readdirSync(out).sort()).toEqual(["LICENSE-fonts.txt", "app.js", "assistant.js", "examples.json", "index.html", "llm-worker.js", "modelgen.js", "panels.js", "shapes.js", "style.css", "viewer.js"]);
